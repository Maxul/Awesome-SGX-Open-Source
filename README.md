...
- **dstack: Open-source framework for secure deployment of containerized applications using Intel TDX and NVIDIA Confidential Computing** [https://github.com/Dstack-TEE/dstack](https://github.com/Dstack-TEE/dstack)
...
- **Haskell: HasTEE - Haskell DSL for Programming TEEs** [https://github.com/Abhiroop/HasTEE](https://github.com/Abhiroop/HasTEE)
...
- **near-ai/private-ml-sdk: SDK for privacy-preserving machine learning with NVIDIA Confidential Computing support** [https://github.com/near-ai/private-ml-sdk](https://github.com/near-ai/private-ml-sdk)
...
- **Phala Cloud: Serverless confidential AI platform for deploying privacy-preserving applications** [https://cloud.phala.network](https://cloud.phala.network)
- **redpill.ai: API platform for privacy-preserving AI model inference and deployment** [https://redpill.ai](https://redpill.ai)
